...
@Component({
  selector: 'app-airline-route-list',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './airline-route-list.component.html',
  styleUrls: ['./airline-route-list.component.scss']
})
export class AirlineRouteListComponent {
